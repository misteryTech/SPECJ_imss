                                        ...
                                        <?php
                                            ...
                                            while ($row = $result->fetch_assoc()) {
                                                ...
                                                if ($row['status'] == 'Rejected') {
                                                    echo "<h3><span class='badge rounded-pill bg-danger'>" . $row['status'] . "</span></h3>";
                                                } else if ($row['status'] == 'Pending'){
                                                    echo "<h3><span class='badge rounded-pill bg-secondary'>" . $row['status'] . "</span></h3>";
                                                } else {
                                                    echo "<h3><span class='badge rounded-pill bg-success'>" . $row['status'] . "</span></h3>";
                                                }
                                                echo "</td>";
                                                ...
                                                echo "<input type='text' class='form-control' id='reorder_supplier" . $row['reorder_id'] . "' name='supplier_id' value='" . $row['supplier_id'] . "' readonly>";
                                                echo "</div>";
