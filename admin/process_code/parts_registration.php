...
if($_SERVER["REQUEST_METHOD"] === "POST") {
    ...
    $stmt = $connection->prepare("INSERT INTO motor_parts_table (parts_name, parts_number, category, manufacturer, price, QuantityInStock, supplier, `condition`, services_type)
        VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?)");
