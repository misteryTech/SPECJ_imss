...
INSERT INTO `c_vehicles_registration_tbl` VALUES (11, 8, 'mio', 2024, 'hqt321', 1500, '421712', '2024-09-04', 'modify motor');
...
INSERT INTO `customers_tbl` VALUES (8, 'ruby', 'esto', 'ruby@gmail.com', '09421663523', 'Gensan', '2024-10-23 20:18:57', 'ruby', 'esto', '');
...
-- ----------------------------
INSERT INTO `motorparts_tbl` VALUES (18, 'Computer', '11100-22223', 'transmission-and-drivetrain', 'showa', 5000.00, '7', '2', '2024-11-11 16:02:20', 'New', 'Motorcycle', 'uploads/131945163_4079243218772496_7963949365508560768_n.jpg', NULL, NULL, '1');
INSERT INTO `motorparts_tbl` VALUES (19, 'brake', '11231231', 'protective-gear', 'wiseco', 250.00, '50', '2', '2024-11-11 16:39:51', 'New', 'Motorcycle', 'uploads/P-BL-R3000_13966_1_750_750.jpeg', NULL, NULL, '0');
INSERT INTO `motorparts_tbl` VALUES (20, 'ASD', '11100-22223', 'protective-gear', 'scorpion-exhausts', 123.00, '11', '2', '2024-11-11 15:50:33', 'New', 'Car', 'uploads/COPMP.jpg', '2024-10-17', NULL, '1');
...
-- ----------------------------
INSERT INTO `order_items` VALUES (1, 1, 20, 1, 123.00);
INSERT INTO `order_items` VALUES (2, 1, 19, 1, 250.00);
INSERT INTO `order_items` VALUES (3, 2, 19, 1, 250.00);
INSERT INTO `order_items` VALUES (4, 3, 19, 998, 250.00);
...
CREATE TABLE `orders`  (
  ...
  INDEX `customer_id`(`customer_id` ASC) USING BTREE,
  CONSTRAINT `orders_ibfk_1` FOREIGN KEY (`customer_id`) REFERENCES `walk_in_customers` (`customer_id`) ON DELETE RESTRICT ON UPDATE RESTRICT
) ENGINE = InnoDB AUTO_INCREMENT = 4 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of orders
-- ----------------------------
INSERT INTO `orders` VALUES (1, 1, '2024-11-08 16:21:48');
INSERT INTO `orders` VALUES (2, 2, '2024-11-11 14:01:16');
INSERT INTO `orders` VALUES (3, 3, '2024-11-11 14:05:33');
...
INSERT INTO `released_parts_tbl` VALUES (8, 2, 19, '2450', '2024-11-11', 'Released');
...
INSERT INTO `return_item_tbl` VALUES (2, 19, 4446, 'adasd', 'Received', '4441', 2, '2024-10-17');
...
INSERT INTO `scheduling_services_tbl` VALUES (2, 8, 11, 1, 'qwdeefa', '2024-10-24', '12:00:00', 2, 'vssds', NULL, NULL, 'Completed');
...
CREATE TABLE `service`  (
  ...
  PRIMARY KEY (`order_id`) USING BTREE,
  INDEX `customer_id`(`customer_id` ASC) USING BTREE,
  CONSTRAINT `service_ibfk_1` FOREIGN KEY (`customer_id`) REFERENCES `walk_in_customers` (`customer_id`) ON DELETE RESTRICT ON UPDATE RESTRICT
) ENGINE = InnoDB AUTO_INCREMENT = 5 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of service
-- ----------------------------
INSERT INTO `service` VALUES (1, 1, '2024-11-08 16:21:48', NULL, NULL, NULL);
INSERT INTO `service` VALUES (2, 2, '2024-11-11 14:01:16', NULL, NULL, NULL);
INSERT INTO `service` VALUES (3, 3, '2024-11-11 14:05:33', NULL, NULL, NULL);
INSERT INTO `service` VALUES (4, 4, '2024-11-11 15:06:54', 'Tune up', 150.00, NULL);
...
-- ----------------------------
INSERT INTO `services_tbl` VALUES (1, 'Motorcycle', 'Tune up', 150.00, 'Tune up using machine', '1');
INSERT INTO `services_tbl` VALUES (2, 'Motorcycle', 'kalkal pipe', 300.00, 'cafsjdsjds', '1');
...
INSERT INTO `suppliers_tbl` VALUES (3, 'mark', 'jing', 'mark@gmail.com', '09733555666', 'maaisim', '2024-10-23 20:48:29', '', 'mark', 'mark123');
...
-- ----------------------------
-- Table structure for walk_in_customers
-- ----------------------------
...
-- ----------------------------
-- Records of walk_in_customers
-- ----------------------------
INSERT INTO `walk_in_customers` VALUES (1, 'reymark', '09124804022', 'yusaville sinawal');
INSERT INTO `walk_in_customers` VALUES (2, 'Sample', '09635437123', 'gensan');
INSERT INTO `walk_in_customers` VALUES (3, 'Sample', '09635437123', 'asd');
INSERT INTO `walk_in_customers` VALUES (4, 'Sample', '09635437123', 'asd');
