<?php
      ...
      if($_SERVER["REQUEST_METHOD"] === "POST"){
          ...
          //sanitize the encoded data
        $stmt = $connection->prepare("INSERT INTO user_table(firstname,lastname,email,username,password) VALUES
        (?,?,?,?,?)");
            ...
            <div class="col-lg-4 col-md-8 d-flex flex-column align-items-center justify-content-center">
              ...
              <div class="d-flex justify-content-center py-4">
                <a href="index.html" class="logo d-flex align-items-center w-auto">
                  ...
                  <span class="d-none d-lg-block">SPECJ Motor Services</span>
                </a>
              </div><!-- End Logo -->
