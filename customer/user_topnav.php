...
<div class="d-flex align-items-center justify-content-between">
  <a href="admin_dashboard.php" class="logo d-flex align-items-center">
    ...
    <span class="d-none d-lg-block">Hi! <?php echo $_SESSION['c_firstname']; ?></span>
  </a>
    ...
    <li class="nav-item dropdown pe-3">
      ...
      <ul class="dropdown-menu dropdown-menu-end dropdown-menu-arrow profile">
        <li class="dropdown-header">
          <h6><?php echo htmlspecialchars($_SESSION['c_firstname']). ' ' .  htmlspecialchars($_SESSION['c_lastname']); ?></h6>
          <span>Customer</span>
        </li>
        <li>
        ...
        <li>
          <a class="dropdown-item d-flex align-items-center" href="user_userprofile.php">
