...
$events_url = "process_code/load_services_scheduled.php?mechanic_id=$mechanic_id";
?>
...
<section class="section">
    <div class="row">
        <div class="col-lg-12">
            <div class="card">
                <div class="card-body">
                    <h5 class="card-title"> <?php echo htmlspecialchars( $_SESSION['username'] ); ?> Scheduled Services Calendar</h5>
                    <div id='calendar'></div>
                </div>
            </div>
        </div>
